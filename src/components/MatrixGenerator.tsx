...
export default function MatrixGenerator({ rows, setRows, subject, setSubject }: MatrixGeneratorProps) {
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm pb-4 pt-4 border-b border-gray-200 -mx-6 px-6 shadow-sm mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button onClick={addRow} className="bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200">
